// Code for setting the date and time manually (must enter current date and time)
...
void setup () {
    ...
    RTC.adjust(DateTime(2018, 5, 02, 11, 33, 40)); //current date and time in the format (yyyy, mm, dd, hh, mm, ss)
}
