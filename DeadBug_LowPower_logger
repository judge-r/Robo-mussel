...
// 07.02.2014
//-------------------------------------------------------------------------------
//boolean value set-up with an if-else statement, create new global variable
//declare a global variable that is first true and then make a new block and make it false
